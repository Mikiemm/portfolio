    ...
    render={({ site, file }) => {
      ...
      <Header>
        ...
        <Links>
          ...
          <Remote alt="LinkedIn" rel="noopener" href="https://www.linkedin.com/in/marketa-svid" target="_blank">
          ...
          <Remote alt="Dribbble" rel="noopener" href="https://dribbble.com/marketa" target="_blank">
            <svg width="20" height="20" viewBox="0 0.2 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
