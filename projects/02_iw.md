...
<full-width color="#f3f8ff">
  ...
  <div class="row">
    <div class="column_2">
      <ul>
        <li>The site is <strong>confusing; it’s hard to navigate</strong> and find out what it’s suitable for them</li>
        <li>They work out in a gym by themselves or with a <strong>mobile app</strong></li>
      </ul>
    </div>

   <div class="column_2">
      <ul>
        <li>The appearance of the site looks too dull and unmotivating</li>
      </ul>
    </div>
  </div>
